...
<br><br><br><br>
Additional tip: If you are as lazy as I am sometimes (remember laziness WILL get you far in programing) you can add this function to your ~/.bash_profile or whatever your OS uses ro replace this three lines by one.
<br><br><br>
...
#### 1. Make you code work on other machines <br> 
...
Try to make ALL your code work seemlessly on another computer with the another operating system (OS) than yours (if you are on mac/linux try on windows and vice versa since mac/linux are oten really similar). 

To make your life easier (and impress you colleagues and supervisors) you might want to take a look at repoducible workflows such as [repro](https://github.com/aaronpeikert/repro) for R or [this](https://swcarpentry.github.io/2014-01-31-ucsb/lessons/jk-python/reproducible_workflow.html) for Python.
...
Let's start by downloading an [example dataset](https://drive.google.com/drive/folders/1vVW3jPfYdvh52juiHTUnkmY6bjvxZQcR)
and install [dcm2niix[(https://github.com/rordenlab/dcm2niix) (this is just a tool to transform raw dicom (.dcm) files to niifti (.nii) with their metadata (.json)
